...
def create_presentation():
    ...
    with open('structured_data_v4.json', 'r', encoding='utf-8') as f:
    ...
    for slide_info in slides_data:
        ...
        title_text = re.sub(r'(\d)\s+\.', r'\1.', title_text) # Fix "9 ."
    ...
    prs.save("OTTOBITE_Sunum_Final_V4.pptx")
    print("V4 Presentation generated.")
